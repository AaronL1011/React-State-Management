      ...
      leftElement={
        <VStack spacing={4} maxWidth='600px'>
          <Text>
            ...
            state colocation. Notice how all the components re-render on
            clicking the counter button? This is because of the call to{' '}
            <Code>setCount</Code> at the parent level. Now try the other
            component!
          </Text>
