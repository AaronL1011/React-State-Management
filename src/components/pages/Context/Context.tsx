        ...
        leftElement={
          <VStack spacing={4} maxWidth='600px'>
            <Text>
              ...
              our <Code>count</Code> triggers a re-render of the page, but the
              static elements don&apos;t re-render.
            </Text>
            <ConnectedCounter />
          </VStack>
        }
        rightElement={
          <VStack spacing={4} maxWidth='600px'>
            <Text>
              ...
              example, but comes with its own considerations. Context API at the
              app-level is mainly meant to hold state that changes infrequently,
              such as themes, authenticated user objects, language settings,
              endpoint lookups and other values that would require the app to
              re-render anyway. If you&apos;re in a case where you need Context
              for a frequently changing value, consider how low you can push
              your Context Provider in your component tree while still making
              sense in your app structure.
            </Text>
            <ConnectedCounter />
          </VStack>
        }
